...
l5 = Label(root,text='\u2022 For nCr and nPr, input in the same format or input in the format "n,r" and click on the respective button for the result.', font=('Times new roman',15))
l5.place(x = 20, y = 125)
lsub1 = Label(root, text='(Eg: 6C2 or 6c2 or 6P2 or 6p2 or 6,2)', font=('Times new roman',15))
lsub1.place(x=45,y=150)

l6 = Label(root,text='\u2022 For LCM and HCF, input all the numbers seperated by commas and click on the respective button for the result.', font=('Times new roman',15))
l6.place(x = 20, y = 175)
...
l9 = Label(root,text='\u2022 The default angle input/output is Degrees. It can be changed using the angle toggle buttons.', font=('Times new roman',15))
l9.place(x = 20, y = 250)

b1 = Button(root, text="Let's Go!", command=root.destroy, font=('calibri', 12 ,'bold'), width=10, height=1, bd=4, relief=RAISED)
b1.place(x = 450, y = 280)
