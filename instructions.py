...
l6 = Label(root,text='\u2022 For LCM and HCF, input all th numbers seperated by commas and clickon the respective button for the result.', font=('Times new roman',15))
l6.place(x = 20, y = 150)

b1 = Button(root, text="Let's Go!", command=root.destroy, font=('calibri', 12 ,'bold'), width=10, height=1, bd=4, relief=RAISED)
b1.place(x = 450, y = 175)
